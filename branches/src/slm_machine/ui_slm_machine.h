...
public:
    ...
    void setupUi(QMainWindow *slm_machineClass)
    {
        ...
        actionEncryption_Key = new QAction(slm_machineClass);
        actionEncryption_Key->setObjectName(QString::fromUtf8("actionEncryption_Key"));
        ...
        menuBar->setGeometry(QRect(0, 0, 224, 24));
        ...
        menuMenu->addAction(actionEncryption_Key);
    ...
    void retranslateUi(QMainWindow *slm_machineClass)
    {
        ...
        actionEncryption_Key->setText(QApplication::translate("slm_machineClass", "Encryption Key", 0, QApplication::UnicodeUTF8));
